...
embedding_layer_state = reshape(...
  ...
  numhid1 * numwords, []); % the dimension is 150 by 100;
...
%hidden_layer_state : dim is 200*100;
...
output_layer_state = output_layer_state ./ repmat(...
  sum(output_layer_state, 1), vocab_size, 1); % every colomn is a probability , meaning that each batch , the column has some prob distribution over all the 250 words. 
